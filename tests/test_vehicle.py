...
def test_create_vehicle_df_notfound_output(mock_vehicle_list, negative_mock_data):
    with patch("quote_generator_api.vehicle.pull_vehicle_data", return_value=negative_mock_data):
        actual_data = create_vehicle_df(mock_vehicle_list)
