...
from quote_generator_api.utility import get_resource_data, convert_to_df, convert_df_to_json, concat_df, filter_df, convert_col_to_numeric, write_multiple_df_to_json
...
def test_convert_col_to_numeric(mock_data):
    mock_dataframe = pd.DataFrame(mock_data)
    expected_output = pd.DataFrame([{'created': '2025-08-23T20:11:48.569Z', 'edited': '2025-08-23T20:11:48.569Z', 'consumables': '2 months',
